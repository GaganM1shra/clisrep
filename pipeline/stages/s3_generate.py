...
<div class="insight-box green">~47 tickets/month could be auto-resolved today (secrets, grafana access, plugin updates, outbox unblocking)</div>
<div class="insight-box amber">Estimated savings: ~94 engineer-hours/month at 2hr avg per automatable task</div>
...
<ul class="bar-list">
{"".join(f'''<li><span class="bar-label">{c.replace("_", " ").title()[:20]}</span><span class="bar-bg"><span class="bar-fill" style="width:{categories[c]['percentage']/max(cat_pcts)*100 if cat_pcts else 0}%;background:var(--accent)"></span></span><span class="bar-value">{categories[c]['percentage']}%</span></li>''' for c in cat_labels[:8])}
</ul>
</div>
</div>
...
Generated by CLISREP Pipeline v1.0.0 | Data period: Feb 14 - Aug 14, 2026 | Sources: Jira CLI ESR + Slack #all-cloud-engineers
</footer>
</div>
